...
with tab1:
    ...
    st.dataframe(best_dept.head(1), use_container_width=True)
    ...
    st.dataframe(best_source.head(1), use_container_width=True)
    ...
    st.dataframe(best_role.head(1), use_container_width=True)
